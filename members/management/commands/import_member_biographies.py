    ...
    def handle(self, *args, **options):
        ...
        for row in rows:
            ...
            try:
                ...
                self.stdout.write(self.style.WARNING(f"Skipping: No matching member for handle {handle}"))
                continue
        ...
        self.stdout.write(self.style.SUCCESS(f"Import complete. Total biographies processed: {imported}"))
