...
def is_active_member(user, allow_superuser: bool = True, allowed_statuses: Optional[Iterable[str]] = None) -> bool:
    ...
    statuses = list(
        allowed_statuses) if allowed_statuses is not None else ALLOWED_MEMBERSHIP_STATUSES
