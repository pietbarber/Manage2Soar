...
class TimeOfDayOperationsTestCase(TestCase):
    ...
    def test_time_of_day_operations_structure(self):
        ...
        self.assertIsInstance(result['mean_takeoff_times'], list)
        self.assertIsInstance(result['mean_landing_times'], list)
    ...
    def test_time_of_day_operations_no_data(self):
        ...
        self.assertEqual(result['mean_takeoff_times'], [])
        self.assertEqual(result['mean_landing_times'], [])
