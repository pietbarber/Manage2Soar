...
description: "Fetch unresolved PR review comments, implement fixes, validate, push, reply to each thread, and request the next Copilot review via reviewer request flow"
...
7. Request a new GitHub Copilot review on the PR using reviewer request flow (equivalent to clicking Request in the Reviewers panel), not by posting @copilot in a comment.
