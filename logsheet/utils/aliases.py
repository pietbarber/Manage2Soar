...
TOWPLANE_ALIASES = [
    ...
    {
        "name": "Burner Citabria",
        "start": "2000-01-01",
        "end": "2099-12-31",
        "n_number": "OTHER",
    },
    {
        "name": "Other Tow Plane NA",
        "start": "2000-01-01",
        "end": "2099-12-31",
        "n_number": "OTHER",
    },
    {
        "name": "SVS Pawnee N7298Z",
        "start": "2000-01-01",
        "end": "2099-12-31",
        "n_number": "N7298Z",
    },
    ...
    {
        "name": "Stahl Skyhawk N5323R",
        "start": "2000-01-01",
        "end": "2099-12-31",
        "n_number": "N5323R",
    },
    {
        "name": "M-ASA Super Cub",
        "start": "2000-01-01",
        "end": "2099-12-31",
        "n_number": "OTHER",
    },
...
def resolve_towplane(name, flight_date, comment=""):
    ...
    for entry in TOWPLANE_ALIASES:
        if (
            ...
            and entry["start"] <= str(flight_date) <= entry["end"]
        ):
