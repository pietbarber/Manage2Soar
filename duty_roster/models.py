...
class DutyAssignment(models.Model):
    ...
    duty_officer = models.ForeignKey(
        Member, null=True, blank=True, on_delete=models.SET_NULL, related_name="as_duty_officer")
    assistant_duty_officer = models.ForeignKey(
        Member, null=True, blank=True, on_delete=models.SET_NULL, related_name="as_ado")
    instructor = models.ForeignKey(
        Member, null=True, blank=True, on_delete=models.SET_NULL, related_name="as_instructor")
    surge_instructor = models.ForeignKey(
        Member, null=True, blank=True, on_delete=models.SET_NULL, related_name="as_surge_instructor")
    tow_pilot = models.ForeignKey(
        Member, null=True, blank=True, on_delete=models.SET_NULL, related_name="as_tow_pilot")
    surge_tow_pilot = models.ForeignKey(
        Member, null=True, blank=True, on_delete=models.SET_NULL, related_name="as_surge_tow_pilot")
    surge_notified = models.BooleanField(
        default=False)         # for instructor emails
    tow_surge_notified = models.BooleanField(
        default=False)     # for tow pilot emails
...
class InstructionSlot(models.Model):
    ...
    instructor = models.ForeignKey(
        Member, null=True, blank=True, on_delete=models.SET_NULL, related_name='assigned_students')
    ...
    status = models.CharField(
        max_length=20, choices=STATUS_CHOICES, default='waitlist')
