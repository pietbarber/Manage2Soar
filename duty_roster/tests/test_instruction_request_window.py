...
# NOTE: The following three tests (test_ops_intent_toggle_*) were removed because
# they tested a flow that does not exist in the current codebase:
#  - The URL pattern for ops_intent_toggle uses year/month/day kwargs, not pk.
#  - InstructionSlot has no 'date' field (use assignment__date).
#  - ops_intent_toggle does not create InstructionSlots; instruction requests
#    go through the request_instruction view.
# Instruction-request-window enforcement is already covered by the calendar day
# detail tests above.
